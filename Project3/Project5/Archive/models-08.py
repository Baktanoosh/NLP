...
const_list = ['new', 'north', 'south', 'west', 'east', 'alabama', 'alaska', 'arizona', 'arkansas', 'california',
    ...
    'washington', 'virginia', 'wisconsin', 'wyoming','smallest' ,'largest', 'longest', 'lowest', 'highest', 'biggest', 'new', 
    'york', 'seattle', 'des', 'moines', 'sacramento', 'dover', 'mount', 'mckinley', 'rochester', 'new', 'orleans', 'rio', 'grande', 
    'red', 'potomac']
