...
def train_rnn_classifier(args, train_cons_exs, train_vowel_exs, dev_cons_exs, dev_vowel_exs, vocab_index):
    ...
    freq_Calssifier = train_frequency_based_classifier(train_cons_exs, train_vowel_exs)
    cons_exs_size = freq_Calssifier.consonant_counts
    vowel_exs_size = freq_Calssifier.vowel_counts
    label = freq_Calssifier.predict(context)
