...
const_list = ['new', 'north', 'south', 'west', 'east', 'alabama', 'alaska', 'arizona', 'arkansas', 'california',
    ...
    'washington', 'virginia', 'wisconsin', 'wyoming','smallest' ,'largest', 'longest', 'lowest', 'highest', 'biggest',  
    'york', 'seattle', 'des', 'moines', 'sacramento', 'dover', 'mount', 'mckinley', 'rochester', 'orleans', 'rio', 'grande', 
    'red', 'potomac', 'springfield', 'sd', 'usa', 'durham', 'boulder', 'houston', 'portland', 'austin', 'united', 'states',
    'plano', 'point', 'points', 'chattahoochee', 'detroit', 'american', 'dallas', 'san', 'francisco', 'tucson']
