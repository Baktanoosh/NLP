...
class PerceptronClassifier(SentimentClassifier):
    ...
    def perceptron(self):
        unigram =  UnigramFeatureExtractor(Indexer)
        trainset_len = len(self.train_ex)
        indexer_len = unigram.get_indexer_len()
        ...
        for i in range(self.epoch):
            for j in range(trainset_len):
                features = self.extract.extract_features(self.train_ex[j])
    ...
    def predict(self, ex: SentimentExample):
        feat = self.extract.extract_features(ex)
